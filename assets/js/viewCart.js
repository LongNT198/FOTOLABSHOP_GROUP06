...
/*
<script>
      $('.product__detail').click(function() {
     
     var id = $(this).attr('data');

     console.log(id);
   if (id && products_compare[id]) {
     var productDetailData = products_compare[id],
         DetailContent = '';
         DetailContent += '<div class="col-lg-6 col-md-6">';
         DetailContent += '<div class="product-details">';
         DetailContent += '<div class="product-details-img">';
         DetailContent += '<div class="tab-content jump">';
         DetailContent += '<div id="shop-details-1" class="tab-pane large-img-style">';
         DetailContent += '<img src="images/Categories/BestSeller/PowerShot G7 X Mark III 01.png" alt="">';
         DetailContent += '<span class="dec-price">Best Seller</span>';
         DetailContent += '<div class="img-popup-wrap">';
         DetailContent += '<a class="img-popup" href="images/Categories/BestSeller/PowerShot G7 X Mark III 01.png"><i class="pe-7s-expand1"></i></a>';
         DetailContent += '</div>';
         DetailContent += '</div>';
         DetailContent += '<div id="shop-details-2" class="tab-pane active large-img-style">';
         DetailContent += '<img src="images/Categories/BestSeller/PowerShot G7 X Mark III 02.png" alt="">';
         DetailContent += '<span class="dec-price">Best Seller</span>';
         DetailContent += '<div class="img-popup-wrap">';
         DetailContent += '<a class="img-popup" href="images/Categories/BestSeller/PowerShot G7 X Mark III 02.png"><i class="pe-7s-expand1"></i></a>';
         DetailContent += '</div>';
         DetailContent += '</div>';
         DetailContent += '<div id="shop-details-3" class="tab-pane large-img-style">';
         DetailContent += '<img src="images/Categories/BestSeller/PowerShot G7 X Mark III 01.png" alt="">';
         DetailContent += '<span class="dec-price">Best Seller</span>';
         DetailContent += '<div class="img-popup-wrap">';
         DetailContent += '<a class="img-popup" href="images/Categories/BestSeller/PowerShot G7 X Mark III 01.png"><i class="pe-7s-expand1"></i></a>';
         ...
         DetailContent += '</div>';
         DetailContent += '</div>';
         DetailContent += '<div class="shop-details-tab nav">';
         DetailContent += '<a class="shop-details-overly" href="#shop-details-1" data-bs-toggle="tab">';
         DetailContent += '<img src="images/Categories/BestSeller/PowerShot G7 X Mark III 01.png" alt="">';
         DetailContent += '</a>';
         DetailContent += '<a class="shop-details-overly active" href="#shop-details-2" data-bs-toggle="tab">';
         DetailContent += '<img src="images/Categories/BestSeller/PowerShot G7 X Mark III 02.png" alt="">';
         DetailContent += '</a>';
         DetailContent += '<a class="shop-details-overly" href="#shop-details-3" data-bs-toggle="tab">';
         DetailContent += '<img src="images/Categories/BestSeller/PowerShot G7 X Mark III 01.png" alt="">';
         DetailContent += '</a>';
         DetailContent += '</div>';
         DetailContent += '</div>';
